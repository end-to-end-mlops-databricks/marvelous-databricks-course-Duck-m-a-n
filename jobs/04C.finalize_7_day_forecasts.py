# 04C.finalize_7_day_forecasts.py
...
def main():
    ...
    # Load Parameters
    job_timestamp_utc = dbutils.jobs.taskValues.get(taskKey="Determine7DayForecastPath", key="job_run_date")
    ...
    prediction_dataset = "intermediate_7_day_predictions"
    test_set_table_name = "feature_set"
    full_table_name = f"{catalog_name}.{schema_name}.Dept_Store_7_Day_Forecast"
    ...
    spark.sql(f"DROP TABLE IF EXISTS {catalog_name}.{schema_name}.{prediction_dataset}")
