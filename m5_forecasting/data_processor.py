...
class DataProcessor:
    ...
    def add_sell_prices(self):
        ...
        self.sales_data = self.sales_data.merge(
            self.sell_prices[['unique_id', 'wm_yr_wk', 'sell_price']],
    ...
    def filter_before_release(self):
        ...
        self.sales_data = self.sales_data[self.sales_data['wm_yr_wk'] >= self.sales_data['release']].reset_index(drop=True)
    ...
    def finalize_dataset(self):
        ...
        desired_column_order = ['unique_id', 'ds', 'y', 'sell_price', 'num_events', 'cat_id', 'dept_id', 'state_id', 'store_id',
                                'day_of_week', 'is_weekend', 'day_of_month', 'week_of_month', 'month', 'week_num_year', 'year']
